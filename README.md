...
Install the MSVC development libraries from [libsdl.org](http://www.libsdl.org/):
- Download `SDL2-devel-2.x.x-VC.zip`, `SDL2_image-devel-2.x.x-VC.zip`, and `SDL2_ttf-devel-2.x.x-VC.zip`
- Copy the lib and dll files to the project directory
